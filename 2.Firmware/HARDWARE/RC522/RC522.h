...
#define RC522_RST_PIN GPIO_Pin_14
#define RC522_RST_Set() GPIO_SetBits(RST_PORT, RST_PIN)
#define RC522_RST_Clr() GPIO_ResetBits(RST_PORT, RST_PIN)

#define RC522_CS_Clr() GPIO_ResetBits(GPIOA, GPIO_Pin_15)
#define RC522_CS_Set() GPIO_SetBits(GPIOA, GPIO_Pin_15)
